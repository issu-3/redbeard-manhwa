...
interface SearchClientProps {
  dynamicGenres: Array<{ name: string; slug: string; iconName?: string | null; color?: string | null }>;
  dynamicTrending: string[];
}

export default function SearchClient({ dynamicGenres, dynamicTrending }: SearchClientProps) {
          ...
          <div className="space-y-10">
            ...
            <section>
              ...
              <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-5">
                {dynamicGenres.slice(0, 10).map((genre, i) => (
                  <GenreCard key={genre.slug} genre={{ name: genre.name, slug: genre.slug, icon: genre.iconName || 'Hash', color: genre.color || '#E53935' }} variant="compact" index={i} />
                ))}
              </div>
            </section>
          </div>
